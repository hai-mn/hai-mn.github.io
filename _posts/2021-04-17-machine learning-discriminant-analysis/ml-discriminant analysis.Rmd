...
performance will suffer  
  - LDA can only learn linear decision boundaries between classes (this isn’t the case for
QDA)  
  - LDA assumes equal covariances of the classes and performance will suffer if this isn’t
the case (this isn’t the case for QDA)   
...
__When we should apply LDA vs QDA__    
  ...
  3. If LDA’s assumption of common covariance matrix is poor, then LDA has high bias.  
...
- Our LDA model correctly classified 98.8% of wine bottles, on average! There isn’t much
