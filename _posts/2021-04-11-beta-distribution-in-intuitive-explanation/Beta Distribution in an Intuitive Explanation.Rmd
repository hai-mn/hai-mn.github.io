...
```{r}
ggplot(data=df, aes(x=p))+
  stat_function(fun=dbeta, args=list(shape1=900, shape2=100), aes(colour = "alpha=900,beta=100")) + 
  stat_function(fun=dbeta, args=list(shape1=90, shape2=10), aes(colour = "alpha=90,beta=10")) +
  stat_function(fun=dbeta, args=list(shape1=30, shape2=70), aes(colour = "alpha=30,beta=70")) +
  stat_function(fun=dbeta, args=list(shape1=3, shape2=7), aes(colour = "alpha=4,beta=4")) +
